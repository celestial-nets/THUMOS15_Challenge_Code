...
load VAL_FrameRate
% g_scW = gpuArray(scW);
g_scW = gpuArray(scW0826);

% pry_path = '/media/yuanjun/Data/SeagateIV/thumos15_valfeat/PRY_VAL_FEAT/';
...
%     [FRM_SC, N_FEAT] = genFrmLBL(SC, N, OBJ_FEAT, g_svmW);
    ...
    ANO{i} = getANO20150708([uniqVid{i, 1}, '.mp4'], FRM_SC, N_FEAT, FrameRate(i), []);
...
fileID = fopen('val_run0826_newW.txt', 'w');
