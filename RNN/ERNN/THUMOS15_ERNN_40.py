...
# region NumPy Test
data = sio.loadmat('D14_P44_PY_nodrop.mat')
dataW = sio.loadmat('../../data/scW0302_P14.mat')
...
# endregion
sio.savemat('ERNN_pram40_s.mat', {'Wx':v1[0], 'Wh':v1[1], 'W':v1[2], 'bh':v1[3], 'b':v1[4], 'pred':output_pred,
