...
# region NumPy Test
data = sio.loadmat('../THUMOS_ERNN/P5D14_P110_PY_nodrop.mat')
...
# endregion
sio.savemat('P5LSTM_pram110.mat', {'lstm_W':v1[0], 'lstm_U':v1[1], 'lstm_b':v1[2], 'W':v1[3], 'b':v1[4], 'pred':output_pred,
